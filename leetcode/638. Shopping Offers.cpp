/*
 ...
 Source:     https://leetcode.com/problems/shopping-offers/#/description
 Difficulty: Medium
 Company:    Google
...
class Solution {
public:
    int shoppingOffers(vector<int>& price, vector<vector<int>>& special, int index, vector<int> needs) {
        ...
        int res = shoppingOffers(price, special, index+1, needs);
        ...
        while (1) {
            ...
            int tmpRes = special[index][needs.size()] * mul;
            tmpRes += shoppingOffers(price, special, index+1, needs);
    ...
    int shoppingOffers(vector<int>& price, vector<vector<int>>& special, vector<int>& needs) {
        int res = shoppingOffers(price, special, 0, needs);
        return res;
    }
};
